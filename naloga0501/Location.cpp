...
Location::Location(const std::string &name, const std::string &street, const std::string &city,
                   const std::string &country, const Coordinates &coordinates) : name(name), street(street), city(city),
                                                                                 country(country),
...
std::string Location::toString() const {
    return name + ", " + street + ", " + city + ", " + country +" coordinates: "+coordinates.toString();
}

const Coordinates &Location::getCoordinates() const {
    return coordinates;
}

void Location::setCoordinates(const Coordinates &coordinates) {
